...
public class KafkaLocalConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        String typeMapping = "PurchaseOrderCreatedEvent:com.teamgold.goldenharvest.domain.purchases.command.application.event.dto.PurchaseOrderCreatedEvent";
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        String typeMapping =
                "PurchaseOrderCreatedEvent:com.teamgold.goldenharvest.domain.purchases.command.application.event.dto.PurchaseOrderCreatedEvent";
        props.put("spring.json.type.mapping", typeMapping);
